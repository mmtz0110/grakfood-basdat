...
// Ambil ID terakhir dari makanan
$query = mysqli_query($conn, "SELECT MAX(id_makanan) AS id_makanan FROM makanan");
...
$simpan = mysqli_query($conn, "
    INSERT INTO makanan (id_makanan, nama_makanan, id_resto, harga) 
